...
void convertIntArrayToCharArray( unsigned char* s_value, int* t_value, int num_chars ) {
...
void gen_irreps_cuda() {
	stringstream ss;
	cout << "// This file is auto-generated by gen_irreps.c, don't modify" << endl;
	cout << "#include \"../cuda/libtrevisancuda.h\"" << endl;
	cout << "#include <iostream>" << endl;
    cout << "#include <cstdlib>" << endl;
	cout << "using namespace std;" << endl;
	...
	for (unsigned n = 1; n <= MAX_FIELD_ORDER; n++) {
		...
		convertIntArrayToCharArray(bytes, bytes_as_int, num_bytes);
